...
OWNED: dict[str, tuple[list[str], list[str]]] = {
    ...
    "17-schema-inference":  (["infer_first", "infer_nullable", "infer_iso", "infer_variant", "infer_freeze"],
                              ["infer_infer_first", "infer_infer_nullable", "infer_infer_iso",
                               "infer_infer_variant", "infer_infer_freeze"]),
    "18-idempotency":       (["idem_append", "idem_merge", "idem_dev", "idem_drift", "idem_collision"],
                              ["idem_idem_append", "idem_idem_merge", "idem_idem_dev",
                               "idem_idem_drift", "idem_idem_collision"]),
    "19-backfill":          (["backfill_window", "prod_stream", "prod_backfill",
                              "backfill_jan", "backfill_feb", "backfill_mar",
                              "range_closed", "range_open", "backfill_idem"],
                              ["backfill_backfill_window", "backfill_prod_stream", "backfill_prod_backfill",
                               "backfill_backfill_jan", "backfill_backfill_feb", "backfill_backfill_mar",
                               "backfill_range_closed", "backfill_range_open", "backfill_backfill_idem"]),
